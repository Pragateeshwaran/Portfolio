...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="flex-1 sm:min-w-[360px] sm:max-w-[360px] w-full"
    >
      <Tilt
        options={{
          max: 45,
    ...
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          links to code repositories and demos in it. It reflects my knowledge
          in Deep Learning.{" "}
          <a
            href="https://github.com/pragateeshwaran"
